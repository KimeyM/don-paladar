...
window.addEventListener('scroll', function(){
  let animacion = document.getElementById('big')
...
window.addEventListener('scroll', function(){
  let animacion = document.getElementById('lat')
  let posicionObj1 = animacion.getBoundingClientRect().top
  let tamañoPantalla = window.innerHeight
...
function Contact() {
  ...
  const handleOnSubmit = e => {
    ...
    axios({
      method: "post",
      url: "https://formspree.io/mdobdjbj",
      data: new FormData(form)
    })
      .then(r => {
        handleServerResponse(true, <p className='enviado'>Enviado con éxito</p>, form);
      })
      .catch(r => {
    ...
    <div id='contact'>
        <div className="grid">
            <div id='lat' className="lateral">
                ...
                <div className="d7"><a href="https://api.whatsapp.com/send?phone=+5493416805016" target="_blank" rel="noreferrer noopener" style={{ textDecoration: 'none', color:"#ffffff88" }} > 341 680-5016 </a></div>
                <div className="d3">
                ...
                <div className="d8">
                  <CopyToClipboard text='donpaladarcicudown@gmail.com'>
